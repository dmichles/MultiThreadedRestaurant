...
public class Manager {      // Singleton
    ...
    private final Queue<Order> orderInProcessQueue = new ConcurrentLinkedQueue<>();
    ...
    public Table getNextTable() {           // The waiter walks in a circle from Table 1 to 10
    ...
    public Queue<Order> getOrderInProcessQueue() {
        return orderInProcessQueue;
    }
}
